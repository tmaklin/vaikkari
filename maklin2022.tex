...
\begin{abstract}
  ...
  lineages of bacterial species. The first of these methods is mWEEP,
...
introduction of RNA-Seq (TODO citations), where sequencing is used to
identify the expresison levels of different isoforms. Their use has
...
timeframes and are reflected in sequence data obtained from what is
...
descendant of the same culture that produecd the reference sequence.
...
reliablity of the results. Our approach does not place constraints on
...
originaly introduced pseudoalignments, but the mGEMS paper introduced
...
in the likelihood function of the mixure models that have previously
