...
introduce my own attempt at increasing the resolution to the
within-species level with several strains present.
% TODO check that mSWEEP and mGEMS are introduced in this section
...
contigs may plausibly belong to several taxons, which has led to the
...
samples has emerged (TODO cite striange, strianphlan, midas?). Methods
...
%%%%%%%%%%
%% WIP
%% continue from here with " all three ..... "

Both profiling and binning methods can further be divided into those
that leverage reference data and those that attempt reference-free
estimation. While reference-free estimation can yield data from
previously unknown species or strains, reference-based approaches
typically obtain higher resolution. Leveraging reference data is one
of the central aspects of the work in this thesis to perform both
taxonomic profiling (mSWEEP) and taxonomic binning (mGEMS), and the
benefits of a reference-based approach will be explored in more detail
later on.

These metagenomics approaches have found widespread applications in % mentioned already
