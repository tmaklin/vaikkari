...
The mGEMS pipeline is the method that has been applied in the third
paper with the additional inclusion of a postprocessing step aimed at
identifying whether the reference sequences suitably cover the reads
or not. This postprocessing step, demix\_check
(\url{https://github.com/harry-thorpe/demix_check/}) was not developed
by the authors of mSWEEP and mGEMS but addresses an important problem
in determining whether the results from mSWEEP and mGEMS are correct
or not. It is our recommendation that a similar step is used if mSWEEP
and mGEMS are applied, hence the acknowledgement here.
