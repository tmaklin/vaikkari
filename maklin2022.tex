...
\begin{acknowledgements}
  ...
  occasional prodding none of the things I have been fortunate enough
  to do and experience during this journey would not have been
  possible. You have been extraordinarily helpful when needed and
  necessarily stern when required.

  Like many great achievements in life, the research in this thesis is
  the result of collective work. Accordingly, I want to thank all of
  the incredible individuals who made the bigger picture manifest by
  collaborating with me. In no particular order, Teemu Kallonen for
  his assistance and contributions to the early phases of my research
  career; Eva Heinz for taking up the task of running experiments on
  short notice during a pandemic, \O rjan Samuelsen and Kristin
  Hegstad for their assistance in the aforementioned when plans didn't
  quite work out as hoped for; Jarno Alanko and Veli M\"akinen for
  solving in a single meeting a problem we thought would take months;
  Sophia David, Ben Pascoe, Guillaume M\'eric, David Aanensen, Ed
  Feil, and Sam Sheppard for much appreciated and indispensable
  assistance with the always (to me) challenging microbiological
  questions; Christine Boinett, Julian Parkhill, and Stephen Baker for
  kindly lending us their results, data, and assistance in a time of
  need; Yan Shao and Trevor Lawley for their helpful comments when we
  analysed results of their work; Alan McNally and P\aa l Johnsen for
  their shrewd comments and suggestions in our transition to analysing
  clinically relevant cases; and finally Jukka's team and my future
  coworkers Harry Thorpe, Anna P\"ontinen, Rebecca Gladstone, and
  Maiju Pesonen for their contributions and collaboration in the
  latter parts of my work. Without all of you, both the results and
  the road there would have been a much rougher ride.
  ...
  company for extensive lunch \& coffee breaks. In particular I would
  like to thank Mikko Heikkil\"a and Joonas J\"alko for certain
  extracurricular activities involving fermented grains, but also all
  others in the group for their much-needed peer support. Although
  this may not have resulted in academically measurable contributions,
  the impact of a supportive environment is not to be underestimated
  and I owe you my gratitude. I also thank all the other amazing,
  brilliant, and wonderful people who I've met during my doctoral
  studies and copious related activities at the University of
  Helsinki, and who I've had the pleasure of chatting, advocating,
  venting, and simply existing with.
