...
\author{Tommi Mäklin}
\authorcontact{tommi.maklin@helsinki.fi\par
  \url{https://maklin.fi/}}
\pubtime{June}{2022}
\reportno{0}
...
\begin{figure}[!h]
  \label{fig:vb-estimates}
    ...
    \caption{Parameter estimates for the mSWEEP model inferred using
      ...
      each subplot is 1.0 at the column corresponding to the highest estimate.}
\end{figure}
\begin{figure}[!h]
...
\citep{feldgarden2021amrfinderplus}. These analysis and the
...
(\url{https://doi.org/10.12688/wellcomeopenres.15639.2}).
\subsection*{Publication II \textemdash{ } Bacterial genomic epidemiology with mixed samples}
By \underline{Tommi Mäklin}, Teemu Kallonen, Jarno Alanko, Ørjan
Samuelsen, Kristin Hegstad, Veli Mäkinen, Jukka Corander, Eva Heinz,
and Antti Honkela. Published in \textit{Microbial Genomics} (2021)
7.11 (\url{https://doi.org/10.1099/mgen.0.000691}).
...
Ørjan Samuelsen, Trevor D Lawley, Antti Honkela, and Jukka
Corander. Submitted; preprint available from \textit{bioRxiv} (2022)
(\url{https://doi.org/10.1101/2022.06.19.496579}).
