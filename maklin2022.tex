...
for handling cases where the sequencing reads originate from a
...
presents some obvious advantages in increasing the
...
2010's can be seen as entering a transformative period with the price
of data generation decreasing and more powerful computation tools
becoming available. The development of methods such as mSWEEP and
mGEMS will, hopefully, further speed up this transformation and enable
entirely novel types of analyses and discoveries through the inclusion
of metagenomic data.
...
of the results, and writing and editing both the original draft and the
revised manuscript.
...
future analyses but extending them with further isolate data is highly
encouraged.
...
reads. The publications in this thesis employ several different
approaches to the lineage definitions, making use of multilocus
sequence typing (MLST) (TODO citation), and several clustering
algorithms (TODO citations baps + poppunk).
...
the strain-level. Nevertheless, some studies have
...
typical use cases exploit published datasets and possibly combine them
with bespoke isolate sequencing data. Either previously
...
from each species, with the exception of StrainGE, which
explicitly addresses the presence of several strains,
...
we demonstrate in the paper through stochastic dominance (TODO
...
The introduction of mSWEEP and mGEMS will hopefully facilitate these
types of analyses and other research directions. Strain-level
variation is an ubiquitously occurring phenomena (TODO citations) and
its inclusion in epidemiological studies is likely to advance the
field of genomic epidemiology beyond the isolate era. With the rapid
production of high quality reference genomes from long-read sequencing
studies, the applications of the methods can likely be extended beyond
the species that were analysed in this thesis, and insights into the
