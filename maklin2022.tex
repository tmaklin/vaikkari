...
other methods exist for high-resolution analyses of the strain content
exist. The results together with the plate sweep results demonstrate
the usefulness of having a method capable of targeted, high-resolution
analysis of some parts of the microbiome. Additionally, since the
results from the third study were derived from WGS metagenomics data,
the study demosntrated the removal of a significant barrier in
requiring performing plate sweep metagenomics, which has prevented
more widespread application of mSWEEP and mGEMS in the past. These
results show that mSWEEP and mGEMS can used alongside established
tools for metagenome analyses when more information is desired about
some particular subset of organisms within the samples.
...
short-read sequencing data, ignoring the emerging Oxford Nanopore and
...
investigate plasmids. Plasmids are mobile genetic elements carreid by
...
are not able to differentiate between plasmid and chromosome derived
