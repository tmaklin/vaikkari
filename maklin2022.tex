...
\authorcontact{tommi.maklin@helsinki.fi\par
  \url{https://maklin.fi/}}
\pubtime{October}{2022}
\reportno{12}
\isbnpaperback{978-951-51-8694-2}
\isbnpdf{978-951-51-8695-9}
\issn{1238-8645}
\issnonline{2814-4031}
\printhouse{Unigrafia}
\pubpages{165} % --- remember to update this! 
...
tackle the issue and present methodological advances that open up more
...
\phi_{k}$ in Equation \ref{likelihood:reparametrization}, we set
...
regarding the two methods. Namely, we briefly overview their
performance in various settings, and cover questions related to
...
belonging to different bins. Consequently, we
investigated in Publication II the effect of replacing the
...
\begin{figure}[!ht]
  ...
  \caption{Evaluating mGEMS and mSWEEP on the in vitro benchmark
    data. Panels (a) E. coli and (b) E. faecalis compare the results
    ...
    mGEMS pipeline (vertical axis). The subplot in panel (b) contains
    a zoomed-in view of the points around the origin. Panels (c) and
    (d) compare the abundance estimates from mSWEEP to the ground
    truth relative abundances. Panel (c) shows the absolute difference
    ...
    present in the samples, and lineages truly absent. Panel (d) shows
