...
economic barrier and potential biases introduced by the initial
cultivation step, direct sequencing often requires significantly
higher sequencing depths. Sequencing at depths typical to isolate
analyses often results in excess amounts of host DNA and fails to
provide sufficient resolution for the more elusive members of the
microbiome that are present only at low abundances. Due to these
factors, shotgun metagenomics may be difficult to apply in situations
where researchers are only interested in some subset of bacteria but
wish to perform analyses that require high sequencing depth.
...
whole-genome shotgun metagenomic sequencing data. The introductory
part you are reading now contains the overall ideas presented in the
publications and introduces some of the terminology used further on.
